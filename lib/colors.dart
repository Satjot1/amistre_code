...
const appBarColor = Color.fromRGBO(4, 133, 214, 1);
const webAppBarColor = Color.fromRGBO(42, 47, 50, 1);
const messageColor = Color.fromRGBO(0, 89, 255, 1);
const senderMessageColor = Color.fromRGBO(253, 0, 215, 1);
const tabColor = Color.fromRGBO(0, 0, 0, 1);
