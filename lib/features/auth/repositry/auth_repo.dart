...
import 'package:whatsapp_ui/features/common/common_fire_repo.dart';
...
class AuthRepositry {
  ...
  AuthRepositry(this.auth, this.firestore);
  ...
  void verifyOTP({
    ...
    try {
      ...
      Navigator.pushNamedAndRemoveUntil(
          context, UserInfoScreen.routName, (route) => false);
    } on FirebaseAuthException catch (e) {
      showSnackBar(context: context, content: e.message!);
    }
  }
  ...
  void saveUserDataToFirebase({
    ...
    try {
      ...
      String photoUrl = 'https://i.ibb.co/VSyKtPw/Png-Item-64355-2.png';
